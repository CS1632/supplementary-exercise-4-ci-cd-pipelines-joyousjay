...
public class IntegerOpsTest {
	...
	//@When(seed=4318956302794387789L) @When(seed=5114653844946687991L)
	public void testAdd(@When(seed=4318956302794387789L) @InRange(minInt=0)int x, @When(seed=5114653844946687991L) @InRange(minInt=0) int y) {
